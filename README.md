...
**HiPR (High-Impact Path Ranking)** addresses this by ranking objects according to their estimated contribution to the selected object and then spending a configurable sample budget on that ranked set.
