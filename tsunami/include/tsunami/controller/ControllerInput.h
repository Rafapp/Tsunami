...
// The TLDR of this is that we create a controller struct by polling GLFW for the state of the
// controller and pack it into a struct The inputs also get some quality of life improvements such
// as deadzone and sensitivity adjustments, and trigger normalization Then in the main loop all we
// have to do is declare a controller, poll it, and read values from the struct to move the camera
// around

// TODO: I want to make the controller movmenent a function in here, so the main loop just calls a
// readController function or something
