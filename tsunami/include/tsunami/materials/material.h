...
class Material {
  public:
    ...
    Material& albedo(glm::vec3 c)  { m_gpu.base_color        = glm::vec4(c, 1.f); return *this; }
    Material& metalness(float m)   { m_gpu.base_metalness     = m;                 return *this; }
    Material& roughness(float r)   { m_gpu.specular_roughness = r;                 return *this; }
    Material& ior(float i)         { m_gpu.specular_ior       = i;                 return *this; }
    ...
    Material& transmission(float w) { m_gpu.transmission_weight = w; return *this; }
    ...
    Material& albedo_tex(uint32_t idx)    { m_gpu.albedo_tex_index    = idx; return *this; }
    Material& normal_tex(uint32_t idx)    { m_gpu.normal_tex_index    = idx; return *this; }
    Material& roughness_tex(uint32_t idx) { m_gpu.roughness_tex_index = idx; return *this; }
    Material& emissive_tex(uint32_t idx)  { m_gpu.emissive_tex_index  = idx; return *this; }
